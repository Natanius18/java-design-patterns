package example.natanius.strategy;

import example.natanius.strategy.order.Order;
import example.natanius.strategy.strategies.PayByCreditCard;
import example.natanius.strategy.strategies.PayByPayPal;
import example.natanius.strategy.strategies.PayStrategy;
